...
final class ProtocolInfo{
	...
	public const MINECRAFT_VERSION = 'v1.21';
	
	public const MIN_SUPPORTED_PROTOCOL = 685;
	...
	public static function isSupportedProtocol(int $protocol) : bool {
	  return $protocol >= self::MIN_SUPPORTED_PROTOCOL && $protocol <= self::MAX_SUPPORTED_PROTOCOL;
	}
}
